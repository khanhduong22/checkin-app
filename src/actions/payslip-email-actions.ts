  ...
  try {
    ...
    await sendPayslipEmail({
      ...
      stats: {
        ...
        positiveAdjustments: content?.adjustments ? content.adjustments.filter((a: any) => a.amount > 0).reduce((sum: number, a: any) => sum + a.amount, 0) : 0,
        negativeAdjustments: content?.adjustments ? content.adjustments.filter((a: any) => a.amount < 0).reduce((sum: number, a: any) => sum + Math.abs(a.amount), 0) : 0,
